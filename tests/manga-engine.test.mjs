...
globalThis.fetch = async (input, options = {}) => {
  ...
  if (url.pathname === "/api/health") return json({ ok: true, version: "33.0.0", sources: 4 });
...
assert.equal(api.version, "33.0.0");
...
console.log("manga engine v33: search, PT-BR bridge, pages and CBZ OK");
